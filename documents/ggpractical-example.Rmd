...
** make grid lines orthogonal to the primary direction of interest in your plot ** 
...
never moticed that before, fullrange allows line to extend to full range of axes, not just the data
...
can assign volors to variables manuual

scale_color_manual(values = c(versicolor = "x", setosa = "asdf"))
